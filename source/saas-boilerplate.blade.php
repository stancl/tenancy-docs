...
<dd class="pr-12 mt-2" x-show="openPanel === 8" style="display: none;">
  <p class="text-base leading-6 text-gray-700">
    Laravel 8 (<a href="https://airtable.com/shroy4RrLmQFdj6zz" class="text-indigo-600 hover:text-indigo-500">a new version with Jetstream will be released in the coming months</a>).
