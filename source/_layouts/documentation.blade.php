                        ...
                        <div class="lg:pl-4 md:col-span-6 lg:col-span-4 col-span-8 pb-16 break-words" v-pre>
                            ...
                            <div class="flex justify-end">
                                ...
                                <a href="{{ $page->editLink() }}"
                                   class="hover:bg-gray-600 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray active:bg-gray-800 inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap transition duration-150 ease-in-out bg-gray-700 border border-transparent rounded-l-none rounded-md">
                                    Edit on GitHub
                                </a>
                            </div>
                        </div>
