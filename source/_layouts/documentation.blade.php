                    ...
                    <div class="grid grid-cols-8 gap-4">
                        ...
                        <div class="lg:pl-4 md:col-span-6 lg:col-span-4 col-span-8 pb-16 break-words" v-pre>
                            ...
                            <div class="flex justify-end">
                                <a href="{{ $page->editLink() }}" class="inline-flex" data-turbolinks="false">
                                    <span class="hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-r-none rounded-md">
                                    ...
                                    <span class="hover:bg-gray-600 focus:outline-none focus:border-gray-800 focus:shadow-outline-gray active:bg-gray-800 inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap transition duration-150 ease-in-out bg-gray-700 border border-transparent rounded-l-none rounded-md">
                                        Edit on GitHub
                                    </span>
                                </a>
                            </div>
