...
<dd class="pr-12 mt-2" x-show="openPanel === 7" style="display: none;">
  <p class="text-base leading-6 text-gray-700">
    Yes, you can ask questions on our <a class="text-indigo-600" href="https://archte.ch/discord">Discord community</a>. We also offer paid consulting &mdash; <a class="text-indigo-600" href="/contact/">just shoot us an email.</a>
  </p>
</dd>
</div>
</div>
