    ...
    'v3' => [
        ...
        'Sponsor-only content' => [
            'children' => [
                ...
                'Billable Tenants with Cashier' => 'https://sponsors.tenancyforlaravel.com/sponsors/billable-tenants-with-cashier',
                'Central (SSO-like) Authentication' => 'https://sponsors.tenancyforlaravel.com/sponsors/central-sso-like-authentication',
                'Customer HTTPS Certificates with Ploi' => 'https://sponsors.tenancyforlaravel.com/sponsors/customer-https-certificates-with-ploi',
                'Deploying Applications to Ploi' => 'https://sponsors.tenancyforlaravel.com/sponsors/deploying-applications-to-ploi',
                'Frictionless Testing Setup' => 'https://sponsors.tenancyforlaravel.com/sponsors/frictionless-testing-setup',
                'Queued Onboarding Flow' => 'https://sponsors.tenancyforlaravel.com/sponsors/queued-onboarding-flow',
                'Structuring the Codebase for Clarity' => 'https://sponsors.tenancyforlaravel.com/sponsors/structuring-the-codebase-for-clarity',
                'Tenant Database Management with Ploi' => 'https://sponsors.tenancyforlaravel.com/sponsors/tenant-database-management-with-ploi',
                'Universal (Central & Tenant) Nova' => 'https://sponsors.tenancyforlaravel.com/sponsors/universal-central-and-tenant-nova',
            ],
        ],
    ],
];
